...
This repository is associated with a manuscript by Roebuck et al. in PLOS Water. 
...
All codes to reproduce figures and statistics for this manuscript can be found in EXCHANGE_Manuscript_Analyses.Rmd
...
ec1_water_fticrms_L2.csv <br />
ec1_water_fticrms_meta_L2.csv <br />
...
Download the following files from Roebuck et al., 2025 (insert DOI) and place them in the folder called 'Data' created above.
